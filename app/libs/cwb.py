...
def download_thunder_img(output):
    try:
        res = requests.get("https://www.cwb.gov.tw/Data/lightning/lightning_s.jpg")
...
def get_thunder_data(token):
    resp = urlopen(f"https://opendata.cwb.gov.tw/fileapi/v1/opendataapi/O-A0039-001?Authorization={token}&downloadType=WEB&format=KMZ")
